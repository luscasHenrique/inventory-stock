  ...
  return (
    <>
      ...
      >
        {/* Avatar + Toggle */}
        <div
          className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-4'} p-4`}
        >
          <Tooltip.Provider>
            <Tooltip.Root>
              ...
              return (
                <div key={i} className="relative group">
                  ...
                  {isCollapsed && submenu && openSubmenu === label && (
                    ...
                    >
                      {submenu
                        .filter((sub) => hasAccess(sub.href, userRole))
                        .map((sub, j) => (
                          <Link
                            key={j}
                            href={sub.href}
      ...
      <button
        ...
        } z-50 bg-white border rounded-full p-1 shadow transition-all duration-300`}
